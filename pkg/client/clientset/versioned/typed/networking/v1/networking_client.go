...
import (
	...
	"github.com/GoogleCloudPlatform/gke-gateway-api/pkg/client/clientset/versioned/scheme"
...
func (c *NetworkingV1Client) GCPSessionAffinityFilters(namespace string) GCPSessionAffinityFilterInterface {
	return newGCPSessionAffinityFilters(c, namespace)
}

func (c *NetworkingV1Client) GCPSessionAffinityPolicies(namespace string) GCPSessionAffinityPolicyInterface {
	return newGCPSessionAffinityPolicies(c, namespace)
}
